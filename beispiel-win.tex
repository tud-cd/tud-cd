...
\nodepart{second}
In der Beispieldatei wird ein Hifsgitter (1x1mm) definiert, das
...
%\maketitle
%\test33.02mm\relax
%\typeout{33.02mm = \the\test; topskip = \the\topskip}%
%\vskip 33.02mm\relax
%\vskip -\topskip
%\advance \test by -\topskip
%\vskip\test
...
[anchor=north,yshift=-1.5cm] (bach)
