...
\section{Einführung}
\label{sec:org6074547}
\subsection{Allgemeines}
\label{sec:orgb97a5d7}
\begin{frame}[label={sec:org06439ca}]{Geschichte}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org9318c1a}]{CD-Vorgaben (Handbuch)}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org1d4bba0}]{Designkriterien}
\begin{itemize}
...
\label{sec:org8aedc26}
\begin{frame}[label={sec:org3ee76e1}]{Eine Beispielfolie}
\begin{columns}
