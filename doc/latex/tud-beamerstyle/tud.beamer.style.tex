...
\end{frame}
\subsection*{Hilfsseiten für die Erstellung der Vorlagen}
\begin{frame}
  ...
  \typeout{\tempa}
  \typeout{\the\paperheight x \the\paperwidth}
\end{frame}
...
\begin{frame}{Konzeptionelles}
  ...
  \item Volle Beamer-Unterstützung angestrebt (z.\,B. weitere Seitenverhältnisse)
